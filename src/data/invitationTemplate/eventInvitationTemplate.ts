export const eventInvitationTemplate = {
  ...
  variations: [
    // 1. Event Invitation Letter
    {
      ...
      bestFor: {
        en: "Any event or function",
        hi: "किसी भी कार्यक्रम या आयोजन",
      },
      length: { en: "Medium", hi: "मध्यम" },
      difficulty: { en: "Easy", hi: "आसान" },
      content: {
        en: `Dear [Recipient’s Name],

I hope this message finds you well.

It gives me great pleasure to invite you to attend [Event Name], which will be held on [Date] at [Venue] from [Time].

The event is being organized to [brief purpose of the event], and your presence will add value and make the occasion memorable for all of us.
...
हमें आपको यह बताते हुए अत्यंत प्रसन्नता हो रही है कि [कार्यक्रम का नाम] का आयोजन [तारीख] को [स्थान] पर [समय] से किया जा रहा है।

इस कार्यक्रम का उद्देश्य [कार्यक्रम का संक्षिप्त उद्देश्य] है। आपकी गरिमामयी उपस्थिति इस अवसर को और भी विशेष बना देगी।
