export const migraineSickLeave = {
  breadcrumb: {
  ...
  title: {
    en: "Sick Leave Application for Migraine / Headache",
    hi: "माइग्रेन / सिरदर्द के लिए छुट्टी का आवेदन पत्र"
  },
  subtitle: {
    en: "Learn how to write a sick leave application for migraine or severe headache.",
    hi: "माइग्रेन या तेज़ सिरदर्द के लिए छुट्टी का आवेदन पत्र कैसे लिखें, इसकी पूरी जानकारी यहाँ दी गई है।"
  },
