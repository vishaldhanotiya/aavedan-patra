export const montessoriJobApplicationTemplate = {
  ...
  subtitle: {
    en: "Find Montessori teacher job application formats with guidance, examples, and tips for preschool and kindergarten teaching positions.",
    hi: "प्री-स्कूल और किंडरगार्टन शिक्षण पदों के लिए मोंटेसरी शिक्षक नौकरी आवेदन प्रारूप, उदाहरण और मार्गदर्शन प्राप्त करें।",
  },
...
3. Experience Letters (if any)`,
  ...
  howToWrite: {
    title: {
      en: "Tips to Write a Montessori Teacher Job Application",
      hi: "मोंटेसरी शिक्षक आवेदन टिप्स",
    },
    tips: [
      {
        text: {
          en: "Mention Montessori certification",
          hi: "मोंटेसरी प्रमाणपत्र लिखें",
        },
      },
      {
        text: {
          en: "Highlight play-based learning",
          hi: "खेल आधारित शिक्षण बताएं",
        },
      },
      {
        text: {
          en: "Mention nursery or preschool experience",
          hi: "प्री-स्कूल अनुभव जोड़ें",
        },
      },
    ],
  },
