export const scienceTeacherJobTemplate = {
  breadcrumb: {
  ...
  subtitle: {
    en: "Science teacher job application formats with examples, tips, and guidance for school and coaching teaching positions.",
    hi: "स्कूल और कोचिंग शिक्षण पदों के लिए विज्ञान शिक्षक नौकरी आवेदन प्रारूप, उदाहरण और मार्गदर्शन।",
  },
  ...
  variations: [
    {
      ...
      description: {
        en: "Format for Science teaching roles emphasizing experiments and conceptual clarity.",
        hi: "विज्ञान शिक्षण पदों के लिए प्रारूप।",
      },
      bestFor: {
        en: "Science subject teachers",
        hi: "विज्ञान विषय शिक्षक",
      },
      length: {
        en: "Medium",
        hi: "मध्यम",
...
6. Student Project Documentation`,
  ...
  howToWrite: {
    title: {
      en: "Tips to Write a Science Teacher Job Application",
      hi: "विज्ञान शिक्षक नौकरी आवेदन लिखने के टिप्स",
    },
    tips: [
      {
        text: {
          en: "Mention Science degree and specialization",
          hi: "विज्ञान डिग्री और विशेषज्ञता लिखें",
        },
      },
      {
        text: {
          en: "Highlight lab and experiment experience",
          hi: "प्रयोगशाला अनुभव दिखाएँ",
        },
      },
      {
        text: {
          en: "Explain practical teaching methods",
          hi: "व्यावहारिक शिक्षण विधियाँ बताएं",
        },
      },
      {
        text: {
          en: "Include science fairs and board results",
          hi: "साइंस फेयर और बोर्ड परिणाम जोड़ें",
        },
      },
      {
        text: {
          en: "Mention safety and lab management",
          hi: "लैब सुरक्षा और प्रबंधन लिखें",
        },
      },
      {
        text: {
          en: "Attach Science certificates and B.Ed.",
          hi: "विज्ञान प्रमाणपत्र और B.Ed. संलग्न करें",
        },
      },
    ],
  },
