export const fresherTeacherJobTemplate = {
  breadcrumb: {
  ...
  subtitle: {
    en: "Simple and professional job application guidance for fresher teachers. Learn how to write your first teaching application with tips, FAQs, and examples.",
    hi: "फ्रेशर शिक्षकों के लिए सरल और प्रोफेशनल नौकरी आवेदन मार्गदर्शन। टिप्स, FAQs और उदाहरणों के साथ अपना पहला शिक्षक आवेदन लिखना सीखें।",
  },
...
3. Experience Letters (if any)`,
  ...
  howToWrite: {
    title: {
      en: "Tips to Write a Fresher Teacher Job Application",
      hi: "फ्रेशर शिक्षक नौकरी आवेदन लिखने के टिप्स",
    },
    tips: [
      {
        text: {
          en: "Clearly mention your educational qualification such as B.Ed., D.El.Ed., or relevant degree",
          hi: "अपनी शैक्षणिक योग्यता जैसे B.Ed., D.El.Ed. या संबंधित डिग्री स्पष्ट रूप से लिखें",
        },
      },
      {
        text: {
          en: "Highlight internships, volunteer teaching, or tuition experience if any",
          hi: "यदि हो तो इंटर्नशिप, स्वयंसेवी शिक्षण या ट्यूशन अनुभव का उल्लेख करें",
        },
      },
      {
        text: {
          en: "Show enthusiasm for teaching and working with students",
          hi: "शिक्षण और छात्रों के साथ काम करने के प्रति अपना उत्साह दिखाएं",
        },
      },
      {
        text: {
          en: "Keep the language simple, polite, and professional",
          hi: "भाषा सरल, विनम्र और पेशेवर रखें",
        },
      },
      {
        text: {
          en: "Mention basic skills like communication, classroom management, and patience",
          hi: "संचार, कक्षा प्रबंधन और धैर्य जैसे मूल कौशल बताएं",
        },
      },
      {
        text: {
          en: "Attach resume and academic certificates",
          hi: "रिज्यूमे और शैक्षणिक प्रमाणपत्र संलग्न करें",
        },
      },
      {
        text: {
          en: "Proofread your application before submitting",
          hi: "सबमिट करने से पहले आवेदन को ध्यान से पढ़ें",
        },
      },
    ],
  },
