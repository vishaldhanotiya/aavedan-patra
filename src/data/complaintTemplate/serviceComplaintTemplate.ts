export const serviceComplaintTemplate = {
  ...
  title: {
    en: "Service Complaint Letters",
    hi: "सेवा शिकायत पत्र",
  },

  subtitle: {
    en: "Professional complaint letter formats for poor service, delayed support, billing issues, internet problems, customer service complaints, maintenance delays, and unsatisfactory service experiences.",
    hi: "खराब सेवा, देरी से सहायता, बिलिंग समस्याएँ, इंटरनेट समस्याएँ, ग्राहक सेवा शिकायतें, रखरखाव में देरी और असंतोषजनक सेवा अनुभवों से संबंधित पेशेवर शिकायत पत्र प्रारूप।",
  },
  ...
  variations: [
    // 2. Service Complaint
    {
      ...
      bestFor: {
        en: "Poor service, delay, misbehavior",
        hi: "खराब सेवा, देरी, अनुचित व्यवहार",
      },
