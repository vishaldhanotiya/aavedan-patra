export const workplaceComplaintTemplate = {
  ...
  title: {
    en: "Workplace Complaint Letters",
    hi: "कार्यस्थल शिकायत पत्र",
  },

  subtitle: {
    en: "Professional complaint letter formats for workplace issues including harassment, unfair treatment, salary disputes, policy violations, toxic behavior, discrimination, and employee concerns.",
    hi: "उत्पीड़न, अनुचित व्यवहार, वेतन विवाद, नीति उल्लंघन, विषाक्त व्यवहार, भेदभाव और कर्मचारी समस्याओं से संबंधित पेशेवर कार्यस्थल शिकायत पत्र प्रारूप।",
  },
  ...
  variations: [
    // 3. Workplace Complaint
    {
      ...
      bestFor: {
        en: "HR issues, harassment, misconduct",
        hi: "एचआर समस्याएँ, उत्पीड़न, दुर्व्यवहार",
      },
