...
export const teacherJobApplicationPillarWithEditor = {
  breadcrumb: {
    ...
    template: { en: "Teacher Job Application", hi: "शिक्षक नौकरी आवेदन" }
  },
...
I am writing to express my strong interest in the teaching position at your prestigious institution. With over [years] years of teaching experience at [previousSchool], I have developed a proven track record of helping students achieve academic excellence.

Professional Experience:
• Taught [subjectTaught] to classes [grades] for [years] years
• [achievement]
• Implemented innovative teaching methods and use of technology

I am confident that my experience, dedication, and teaching skills would make me a valuable addition to your faculty.
...
4. Letters of Recommendation`,
      fields: [
        ...
        {
          id: "previousSchool",
          label: { en: "Previous School", hi: "पिछला स्कूल" },
          type: "text" as const,
          placeholder: { en: "XYZ School", hi: "XYZ स्कूल" },
        ...
        },
        {
          ...
          type: "text" as const,
          placeholder: { en: "Improved student performance by 25%", hi: "छात्र प्रदर्शन में 25% सुधार" },
          defaultValue: "Improved student performance by 25% in board examinations"
        },
        {
          id: "signatureName",
          label: { en: "Signature Name", hi: "हस्ताक्षर नाम" },
