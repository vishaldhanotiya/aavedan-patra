...
export const resignationLetters: SubcategoryData = {
  ...
  subcategoryName: { en: "Resignation Letters", hi: "त्यागपत्र" },
  breadcrumb: [
    { en: "Letters", hi: "पत्र", slug:"/letters" },
    { en: "Resignation Letters", hi: "त्यागपत्र", slug:"/letters" },
  ],
  heroTitle: { en: "Resignation Letter Templates", hi: "त्यागपत्र टेम्पलेट" },
  heroDescription: {
    en: "Professional resignation letter formats for leaving jobs gracefully - maintain good relationships with proper notice.",
    hi: "सही ढंग से नौकरी छोड़ने के लिए पेशेवर त्यागपत्र प्रारूप - उचित नोटिस के साथ अच्छे संबंध बनाए रखें।",
  },
  searchPlaceholder: { en: "Search resignation templates…", hi: "त्यागपत्र टेम्पलेट खोजें..." },
  ...
  templates: [
    {
      ...
      description: { en: "Standard resignation format with notice period and gratitude.", hi: "नोटिस अवधि और कृतज्ञता के साथ मानक त्यागपत्र प्रारूप।" },
    ...
    {
      id: "resign-4",
      title: { en: "Career Change Resignation", hi: "करियर परिवर्तन त्यागपत्र" },
    ...
    },
    {
      ...
      description: { en: "Resignation format for retirement with appreciation message.", hi: "सराहना संदेश के साथ सेवानिवृत्ति के लिए त्यागपत्र प्रारूप।" },
      lastUpdated: "Oct 2025",
      views: "15.2k",
    ...
    {
      id: "resign-6",
      title: { en: "Relocation Resignation", hi: "स्थानांतरण त्यागपत्र" },
      description: { en: "Resignation letter due to relocation or family reasons.", hi: "स्थानांतरण या पारिवारिक कारणों से त्यागपत्र।" },
      lastUpdated: "Oct 2025",
      views: "14.4k",
      templateSlug:'relocation-resignation-letter'
    },
  ],
  seoTitle: { en: "About Resignation Letter Templates", hi: "त्यागपत्र टेम्पलेट के बारे में" },
  seoDescription: {
    ...
    hi: "त्यागपत्र औपचारिक रूप से नियोक्ताओं को नौकरी छोड़ने के आपके निर्णय के बारे में सूचित करते हैं।",
  },
  relatedTemplates: [
  ...
  blogPosts: [
    { title: { en: "How to Resign Professionally", hi: "पेशेवर रूप से त्यागपत्र कैसे दें" }, excerpt: { en: "Leave your job on good terms with proper resignation etiquette", hi: "उचित त्यागपत्र शिष्टाचार के साथ अच्छी शर्तों पर अपनी नौकरी छोड़ें" }, readTime: "8 min read", slug: "resign-professionally" },
  ...
  faqs: [
    ...
    { question: { en: "Can I resign via email?", hi: "क्या मैं ईमेल के माध्यम से त्यागपत्र दे सकता हूं?" }, answer: { en: "Yes, email resignation is acceptable, especially for remote work. However, inform your direct manager personally first, then send a formal email. Keep a copy for your records.", hi: "हां, ईमेल त्यागपत्र स्वीकार्य है। हालांकि, पहले अपने प्रत्यक्ष प्रबंधक को व्यक्तिगत रूप से सूचित करें।" } },
    { question: { en: "Should I explain why I'm resigning?", hi: "क्या मुझे यह समझाना चाहिए कि मैं क्यों त्यागपत्र दे रहा हूं?" }, answer: { en: "Brief reason is optional. You can mention 'career growth' or 'personal reasons' without details. No need to criticize the company or colleagues. Keep it positive and professional.", hi: "संक्षिप्त कारण वैकल्पिक है। आप विवरण के बिना 'करियर विकास' या 'व्यक्तिगत कारण' का उल्लेख कर सकते हैं।" } },
  ],
};