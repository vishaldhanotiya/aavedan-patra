...
export const essays100WordsData: SubcategoryData = {
  ...
  breadcrumb: [
    { en: "Essays", hi: "निबंध" },
    { en: "100 Words Essays", hi: "100 शब्द निबंध" },
  ],
...
export const essays200WordsData: SubcategoryData = {
  ...
  breadcrumb: [{ en: "Essays", hi: "निबंध" }, { en: "200 Words Essays", hi: "200 शब्द निबंध" }],
  ...
  templates: [
    { id: "200w-1", title: { en: "Digital India Essay", hi: "डिजिटल इंडिया निबंध" }, description: { en: "200 words essay on Digital India initiative and technology.", hi: "डिजिटल इंडिया पहल और प्रौद्योगिकी पर 200 शब्द निबंध।" }, lastUpdated: "Nov 2025", views: "47.3k", badge: "Popular" },
    { id: "200w-2", title: { en: "Cleanliness Essay", hi: "स्वच्छता निबंध" }, description: { en: "Essay on cleanliness and its importance in 200 words.", hi: "200 शब्दों में स्वच्छता और इसके महत्व पर निबंध।" }, lastUpdated: "Nov 2025", views: "43.8k", badge: "Trending" },
    { id: "200w-3", title: { en: "Environment Protection", hi: "पर्यावरण संरक्षण" }, description: { en: "200 words essay on protecting our environment.", hi: "हमारे पर्यावरण की रक्षा पर 200 शब्द निबंध।" }, lastUpdated: "Nov 2025", views: "40.6k" },
    { id: "200w-4", title: { en: "Women Empowerment", hi: "महिला सशक्तिकरण" }, description: { en: "Essay on women empowerment and equality.", hi: "महिला सशक्तिकरण और समानता पर निबंध।" }, lastUpdated: "Oct 2025", views: "37.2k" },
    { id: "200w-5", title: { en: "Healthy Lifestyle", hi: "स्वस्थ जीवनशैली" }, description: { en: "200 words essay on maintaining a healthy lifestyle.", hi: "स्वस्थ जीवनशैली बनाए रखने पर 200 शब्द निबंध।" }, lastUpdated: "Oct 2025", views: "34.9k" },
    { id: "200w-6", title: { en: "Time Management", hi: "समय प्रबंधन" }, description: { en: "Essay on importance of time management.", hi: "समय प्रबंधन के महत्व पर निबंध।" }, lastUpdated: "Oct 2025", views: "32.1k" },
  ],
...
export const essays500WordsData: SubcategoryData = {
  ...
  breadcrumb: [{ en: "Essays", hi: "निबंध" }, { en: "500 Words Essays", hi: "500 शब्द निबंध" }],
  ...
  templates: [
    { id: "500w-1", title: { en: "Climate Change Essay", hi: "जलवायु परिवर्तन निबंध" }, description: { en: "Comprehensive 500 words essay on climate change and global warming.", hi: "जलवायु परिवर्तन और ग्लोबल वार्मिंग पर व्यापक 500 शब्द निबंध।" }, lastUpdated: "Nov 2025", views: "44.6k", badge: "Popular" },
    { id: "500w-2", title: { en: "Technology Impact Essay", hi: "प्रौद्योगिकी प्रभाव निबंध" }, description: { en: "Essay on impact of technology on society in 500 words.", hi: "समाज पर प्रौद्योगिकी के प्रभाव पर 500 शब्दों में निबंध।" }, lastUpdated: "Nov 2025", views: "41.2k", badge: "Trending" },
    { id: "500w-3", title: { en: "Social Media Essay", hi: "सोशल मीडिया निबंध" }, description: { en: "500 words essay on social media advantages and disadvantages.", hi: "सोशल मीडिया के फायदे और नुकसान पर 500 शब्द निबंध।" }, lastUpdated: "Nov 2025", views: "38.7k" },
    { id: "500w-4", title: { en: "Indian Culture Essay", hi: "भारतीय संस्कृति निबंध" }, description: { en: "Detailed essay on Indian culture and traditions.", hi: "भारतीय संस्कृति और परंपराओं पर विस्तृत निबंध।" }, lastUpdated: "Oct 2025", views: "35.4k" },
    { id: "500w-5", title: { en: "Leadership Essay", hi: "नेतृत्व निबंध" }, description: { en: "Essay on leadership qualities and importance.", hi: "नेतृत्व गुणों और महत्व पर निबंध।" }, lastUpdated: "Oct 2025", views: "32.8k" },
    { id: "500w-6", title: { en: "Career Goals Essay", hi: "करियर लक्ष्य निबंध" }, description: { en: "500 words essay on career aspirations and goals.", hi: "करियर आकांक्षाओं और लक्ष्यों पर 500 शब्द निबंध।" }, lastUpdated: "Oct 2025", views: "30.1k" },
  ],
...
export const speechesData: SubcategoryData = {
  ...
  breadcrumb: [{ en: "Essays", hi: "निबंध" }, { en: "Speeches", hi: "भाषण" }],
  ...
  templates: [
    { id: "speech-1", title: { en: "Welcome Speech", hi: "स्वागत भाषण" }, description: { en: "Welcome speech format for events and programs.", hi: "कार्यक्रमों और समारोहों के लिए स्वागत भाषण प्रारूप।" }, lastUpdated: "Nov 2025", views: "49.7k", badge: "Popular" },
    { id: "speech-2", title: { en: "Vote of Thanks Speech", hi: "धन्यवाद ज्ञापन भाषण" }, description: { en: "Thank you speech template for events and functions.", hi: "कार्यक्रमों और समारोहों के लिए धन्यवाद भाषण टेम्पलेट।" }, lastUpdated: "Nov 2025", views: "45.3k", badge: "Trending" },
    { id: "speech-3", title: { en: "Farewell Speech", hi: "विदाई भाषण" }, description: { en: "Farewell speech for students, teachers, or colleagues.", hi: "छात्रों, शिक्षकों या सहयोगियों के लिए विदाई भाषण।" }, lastUpdated: "Nov 2025", views: "41.8k" },
    { id: "speech-4", title: { en: "Republic Day Speech", hi: "गणतंत्र दिवस भाषण" }, description: { en: "Patriotic speech for Republic Day celebrations.", hi: "गणतंत्र दिवस समारोह के लिए देशभक्ति भाषण।" }, lastUpdated: "Oct 2025", views: "38.6k" },
    { id: "speech-5", title: { en: "Independence Day Speech", hi: "स्वतंत्रता दिवस भाषण" }, description: { en: "Speech template for Independence Day program.", hi: "स्वतंत्रता दिवस कार्यक्रम के लिए भाषण टेम्पलेट।" }, lastUpdated: "Oct 2025", views: "35.2k" },
    { id: "speech-6", title: { en: "Annual Day Speech", hi: "वार्षिक दिवस भाषण" }, description: { en: "Speech format for school annual day functions.", hi: "स्कूल वार्षिक दिवस समारोह के लिए भाषण प्रारूप।" }, lastUpdated: "Oct 2025", views: "32.4k" },
  ],
...
export const moralStoriesData: SubcategoryData = {
  ...
  breadcrumb: [{ en: "Essays", hi: "निबंध" }, { en: "Moral Stories", hi: "नैतिक कहानियां" }],
  ...
  templates: [
    { id: "moral-1", title: { en: "Honesty is the Best Policy", hi: "ईमानदारी सर्वश्रेष्ठ नीति है" }, description: { en: "Moral story teaching the importance of honesty.", hi: "ईमानदारी के महत्व को सिखाने वाली नैतिक कहानी।" }, lastUpdated: "Nov 2025", views: "51.8k", badge: "Popular" },
    { id: "moral-2", title: { en: "Unity is Strength", hi: "एकता में बल है" }, description: { en: "Story showing power of teamwork and unity.", hi: "टीमवर्क और एकता की शक्ति दिखाने वाली कहानी।" }, lastUpdated: "Nov 2025", views: "47.4k", badge: "Trending" },
    { id: "moral-3", title: { en: "Hard Work Pays Off", hi: "कड़ी मेहनत रंग लाती है" }, description: { en: "Inspirational story about perseverance and hard work.", hi: "दृढ़ता और कड़ी मेहनत के बारे में प्रेरक कहानी।" }, lastUpdated: "Nov 2025", views: "43.9k" },
    { id: "moral-4", title: { en: "Kindness Matters", hi: "दयालुता मायने रखती है" }, description: { en: "Heartwarming story teaching compassion and kindness.", hi: "करुणा और दयालुता सिखाने वाली हार्दिक कहानी।" }, lastUpdated: "Oct 2025", views: "40.2k" },
    { id: "moral-5", title: { en: "Patience and Perseverance", hi: "धैर्य और दृढ़ता" }, description: { en: "Story about importance of patience in achieving goals.", hi: "लक्ष्यों को प्राप्त करने में धैर्य के महत्व के बारे में कहानी।" }, lastUpdated: "Oct 2025", views: "37.6k" },
    { id: "moral-6", title: { en: "Helping Others", hi: "दूसरों की मदद करना" }, description: { en: "Moral tale about joy of helping those in need.", hi: "जरूरतमंदों की मदद करने की खुशी के बारे में नैतिक कहानी।" }, lastUpdated: "Oct 2025", views: "34.8k" },
  ],
...
export const paragraphsData: SubcategoryData = {
  ...
  breadcrumb: [{ en: "Essays", hi: "निबंध" }, { en: "Paragraphs", hi: "पैराग्राफ" }],
  ...
  templates: [
    { id: "para-1", title: { en: "My Hobby Paragraph", hi: "मेरा शौक पैराग्राफ" }, description: { en: "Short paragraph about my hobby and interests.", hi: "मेरे शौक और रुचियों के बारे में लघु पैराग्राफ।" }, lastUpdated: "Nov 2025", views: "46.2k", badge: "Popular" },
    { id: "para-2", title: { en: "My Family Paragraph", hi: "मेरा परिवार पैराग्राफ" }, description: { en: "Paragraph describing my family members.", hi: "मेरे परिवार के सदस्यों का वर्णन करने वाला पैराग्राफ।" }, lastUpdated: "Nov 2025", views: "42.7k", badge: "Trending" },
    { id: "para-3", title: { en: "My Country Paragraph", hi: "मेरा देश पैराग्राफ" }, description: { en: "Short paragraph on my country and patriotism.", hi: "मेरे देश और देशभक्ति पर लघु पैराग्राफ।" }, lastUpdated: "Nov 2025", views: "39.4k" },
    { id: "para-4", title: { en: "Festivals of India", hi: "भारत के त्योहार" }, description: { en: "Paragraph about Indian festivals and celebrations.", hi: "भारतीय त्योहारों और समारोहों के बारे में पैराग्राफ।" }, lastUpdated: "Oct 2025", views: "36.1k" },
    { id: "para-5", title: { en: "Importance of Trees", hi: "पेड़ों का महत्व" }, description: { en: "Paragraph on why trees are important for environment.", hi: "पर्यावरण के लिए पेड़ क्यों महत्वपूर्ण हैं पर पैराग्राफ।" }, lastUpdated: "Oct 2025", views: "33.8k" },
    { id: "para-6", title: { en: "Pollution Problem", hi: "प्रदूषण समस्या" }, description: { en: "Short paragraph on pollution and its effects.", hi: "प्रदूषण और इसके प्रभावों पर लघु पैराग्राफ।" }, lastUpdated: "Oct 2025", views: "30.9k" },
  ],
