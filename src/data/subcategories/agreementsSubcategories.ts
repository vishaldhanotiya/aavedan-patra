...
export const businessAgreementsData: SubcategoryData = {
  ...
  templates: [
    { id: "business-1", title: { en: "Partnership Agreement", hi: "साझेदारी समझौता" }, description: { en: "Partnership deed format for business partnerships.", hi: "व्यापार साझेदारी के लिए साझेदारी विलेख प्रारूप।" }, lastUpdated: "Nov 2025", views: "55.9k", badge: "Popular" },
    { id: "business-2", title: { en: "Business Contract Template", hi: "व्यापार अनुबंध टेम्पलेट" }, description: { en: "General business contract for commercial transactions.", hi: "वाणिज्यिक लेनदेन के लिए सामान्य व्यापार अनुबंध।" }, lastUpdated: "Nov 2025", views: "51.4k", badge: "Trending" },
    { id: "business-3", title: { en: "Vendor Agreement", hi: "विक्रेता समझौता" }, description: { en: "Agreement format for vendor and supplier relationships.", hi: "विक्रेता और आपूर्तिकर्ता संबंधों के लिए समझौता प्रारूप।" }, lastUpdated: "Nov 2025", views: "47.6k" },
    { id: "business-4", title: { en: "Service Agreement", hi: "सेवा समझौता" }, description: { en: "Service contract for professional services.", hi: "पेशेवर सेवाओं के लिए सेवा अनुबंध।" }, lastUpdated: "Oct 2025", views: "43.8k" },
    { id: "business-5", title: { en: "Supplier Agreement", hi: "आपूर्तिकर्ता समझौता" }, description: { en: "Agreement template for supplier relationships.", hi: "आपूर्तिकर्ता संबंधों के लिए समझौता टेम्पलेट।" }, lastUpdated: "Oct 2025", views: "40.2k" },
    { id: "business-6", title: { en: "Distribution Agreement", hi: "वितरण समझौता" }, description: { en: "Distributor agreement for product distribution.", hi: "उत्पाद वितरण के लिए वितरक समझौता।" }, lastUpdated: "Oct 2025", views: "37.1k" },
  ],
...
export const employmentContractsData: SubcategoryData = {
  ...
  templates: [
    { id: "employ-1", title: { en: "Employment Agreement", hi: "रोजगार समझौता" }, description: { en: "Standard employment contract with terms and conditions.", hi: "शर्तों और नियमों के साथ मानक रोजगार अनुबंध।" }, lastUpdated: "Nov 2025", views: "59.3k", badge: "Popular" },
    { id: "employ-2", title: { en: "Offer Letter Format", hi: "ऑफर लेटर प्रारूप" }, description: { en: "Job offer letter template with salary and position details.", hi: "वेतन और पद विवरण के साथ नौकरी प्रस्ताव पत्र टेम्पलेट।" }, lastUpdated: "Nov 2025", views: "54.7k", badge: "Trending" },
    { id: "employ-3", title: { en: "Appointment Letter", hi: "नियुक्ति पत्र" }, description: { en: "Formal appointment letter for employees.", hi: "कर्मचारियों के लिए औपचारिक नियुक्ति पत्र।" }, lastUpdated: "Nov 2025", views: "50.2k" },
    { id: "employ-4", title: { en: "Service Contract", hi: "सेवा अनुबंध" }, description: { en: "Employment service contract for contractual positions.", hi: "अनुबंधित पदों के लिए रोजगार सेवा अनुबंध।" }, lastUpdated: "Oct 2025", views: "46.1k" },
    { id: "employ-5", title: { en: "Consulting Agreement", hi: "परामर्श समझौता" }, description: { en: "Consultant agreement for freelance professionals.", hi: "फ्रीलांस पेशेवरों के लिए सलाहकार समझौता।" }, lastUpdated: "Oct 2025", views: "42.8k" },
    { id: "employ-6", title: { en: "NDA Agreement", hi: "एनडीए समझौता" }, description: { en: "Non-Disclosure Agreement for confidential information.", hi: "गोपनीय जानकारी के लिए गैर-प्रकटीकरण समझौता।" }, lastUpdated: "Oct 2025", views: "39.4k" },
  ],
...
export const personalAgreementsData: SubcategoryData = {
  ...
  templates: [
    { id: "personal-1", title: { en: "Personal Loan Agreement", hi: "व्यक्तिगत ऋण समझौता" }, description: { en: "Agreement format for personal loans between individuals.", hi: "व्यक्तियों के बीच व्यक्तिगत ऋण के लिए समझौता प्रारूप।" }, lastUpdated: "Nov 2025", views: "61.7k", badge: "Popular" },
    { id: "personal-2", title: { en: "Money Lending Agreement", hi: "धन उधार समझौता" }, description: { en: "Private money lending contract with repayment terms.", hi: "पुनर्भुगतान शर्तों के साथ निजी धन उधार अनुबंध।" }, lastUpdated: "Nov 2025", views: "56.2k", badge: "Trending" },
    { id: "personal-3", title: { en: "Vehicle Sale Agreement", hi: "वाहन बिक्री समझौता" }, description: { en: "Car/bike sale agreement between buyer and seller.", hi: "खरीदार और विक्रेता के बीच कार/बाइक बिक्री समझौता।" }, lastUpdated: "Nov 2025", views: "51.8k" },
    { id: "personal-4", title: { en: "Property Sale Agreement", hi: "संपत्ति बिक्री समझौता" }, description: { en: "Agreement for property sale and transfer.", hi: "संपत्ति बिक्री और हस्तांतरण के लिए समझौता।" }, lastUpdated: "Oct 2025", views: "47.4k" },
    { id: "personal-5", title: { en: "Family Settlement Deed", hi: "पारिवारिक निपटान विलेख" }, description: { en: "Family property settlement agreement format.", hi: "पारिवारिक संपत्ति निपटान समझौता प्रारूप।" }, lastUpdated: "Oct 2025", views: "43.1k" },
    { id: "personal-6", title: { en: "Consent Letter", hi: "सहमति पत्र" }, description: { en: "Personal consent letter for various purposes.", hi: "विभिन्न उद्देश्यों के लिए व्यक्तिगत सहमति पत्र।" }, lastUpdated: "Oct 2025", views: "39.8k" },
  ],
...
export const legalFormsData: SubcategoryData = {
  ...
  templates: [
    { id: "legal-1", title: { en: "Affidavit Format", hi: "शपथपत्र प्रारूप" }, description: { en: "General affidavit template for sworn statements.", hi: "शपथ बयानों के लिए सामान्य शपथपत्र टेम्पलेट।" }, lastUpdated: "Nov 2025", views: "68.4k", badge: "Popular" },
    { id: "legal-2", title: { en: "Declaration Form", hi: "घोषणा फॉर्म" }, description: { en: "Self-declaration format for various purposes.", hi: "विभिन्न उद्देश्यों के लिए स्व-घोषणा प्रारूप।" }, lastUpdated: "Nov 2025", views: "62.9k", badge: "Trending" },
    { id: "legal-3", title: { en: "Undertaking Format", hi: "वचनबद्धता प्रारूप" }, description: { en: "Undertaking letter template for commitments.", hi: "प्रतिबद्धताओं के लिए वचनबद्धता पत्र टेम्पलेट।" }, lastUpdated: "Nov 2025", views: "57.6k" },
    { id: "legal-4", title: { en: "Power of Attorney", hi: "पावर ऑफ अटॉर्नी" }, description: { en: "POA format for legal representation.", hi: "कानूनी प्रतिनिधित्व के लिए पीओए प्रारूप।" }, lastUpdated: "Oct 2025", views: "52.3k" },
    { id: "legal-5", title: { en: "Legal Notice Format", hi: "कानूनी नोटिस प्रारूप" }, description: { en: "Legal notice template for disputes and claims.", hi: "विवादों और दावों के लिए कानूनी नोटिस टेम्पलेट।" }, lastUpdated: "Oct 2025", views: "48.1k" },
    { id: "legal-6", title: { en: "Consent Form", hi: "सहमति फॉर्म" }, description: { en: "Legal consent form for permissions and approvals.", hi: "अनुमति और अनुमोदन के लिए कानूनी सहमति फॉर्म।" }, lastUpdated: "Oct 2025", views: "44.7k" },
  ],
...
export const applicationFormsData: SubcategoryData = {
  ...
  templates: [
    { id: "form-1", title: { en: "Passport Application", hi: "पासपोर्ट आवेदन" }, description: { en: "Passport application form filling guide.", hi: "पासपोर्ट आवेदन फॉर्म भरने की गाइड।" }, lastUpdated: "Nov 2025", views: "74.3k", badge: "Popular" },
    { id: "form-2", title: { en: "PAN Card Application", hi: "पैन कार्ड आवेदन" }, description: { en: "PAN card form filling format and guidelines.", hi: "पैन कार्ड फॉर्म भरने का प्रारूप और दिशानिर्देश।" }, lastUpdated: "Nov 2025", views: "68.7k", badge: "Trending" },
    { id: "form-3", title: { en: "Aadhaar Update Form", hi: "आधार अपडेट फॉर्म" }, description: { en: "Aadhaar correction and update form template.", hi: "आधार सुधार और अपडेट फॉर्म टेम्पलेट।" }, lastUpdated: "Nov 2025", views: "63.2k" },
    { id: "form-4", title: { en: "Driving License Form", hi: "ड्राइविंग लाइसेंस फॉर्म" }, description: { en: "Driving license application form format.", hi: "ड्राइविंग लाइसेंस आवेदन फॉर्म प्रारूप।" }, lastUpdated: "Oct 2025", views: "58.1k" },
    { id: "form-5", title: { en: "Voter ID Application", hi: "वोटर आईडी आवेदन" }, description: { en: "Voter ID card registration form template.", hi: "वोटर आईडी कार्ड पंजीकरण फॉर्म टेम्पलेट।" }, lastUpdated: "Oct 2025", views: "53.6k" },
    { id: "form-6", title: { en: "Bank Account Form", hi: "बैंक खाता फॉर्म" }, description: { en: "Bank account opening form filling guide.", hi: "बैंक खाता खोलने का फॉर्म भरने की गाइड।" }, lastUpdated: "Oct 2025", views: "49.4k" },
  ],
