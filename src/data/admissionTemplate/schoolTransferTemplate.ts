export const schoolTransferTemplate = {
  ...
  title: {
    en: "School Transfer Application Letter",
    hi: "स्कूल स्थानांतरण आवेदन पत्र",
  },

  subtitle: {
    en: "Ready-made format for school transfer, TC request, school leaving certificate, relocation, and class transfer applications.",
    hi: "स्कूल ट्रांसफर, टीसी अनुरोध, स्कूल लीविंग सर्टिफिकेट, स्थान परिवर्तन और कक्षा परिवर्तन आवेदन के लिए तैयार प्रारूप।",
  },
