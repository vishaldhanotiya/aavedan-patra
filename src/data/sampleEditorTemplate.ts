...
3. Experience Letters`,
      fields: [
        ...
        },
        {
          ...
          tooltip: { en: "Date of application submission", hi: "आवेदन जमा करने की तारीख" }
        },
        {
          id: "schoolName",
          label: { en: "School Name", hi: "स्कूल का नाम" },
          type: "text" as const,
          placeholder: { en: "ABC International School", hi: "ABC इंटरनेशनल स्कूल" },
          defaultValue: "",
          required: true,
          tooltip: { en: "Name of the school you're applying to", hi: "जिस स्कूल में आप आवेदन कर रहे हैं उसका नाम" }
        },
        {
          id: "schoolAddress",
        ...
        },
        {
          ...
          type: "text" as const,
          placeholder: { en: "Application for the Position of Teacher", hi: "शिक्षक पद के लिए आवेदन" },
          defaultValue: "Application for the Position of Teacher",
          tooltip: { en: "Brief description of your application purpose", hi: "आपके आवेदन उद्देश्य का संक्षिप्त विवरण" }
        },
        {
          id: "greeting",
        ...
        },
        {
          ...
          defaultValue: "I am writing to express my interest in the teaching position at your esteemed institution. I have recently completed my B.Ed. from XYZ University and am eager to begin my teaching career.",
          tooltip: { en: "Main content of your application letter", hi: "आपके आवेदन पत्र की मुख्य सामग्री" }
        },
        {
          id: "qualification",
          ...
          tooltip: { en: "Your educational qualification", hi: "आपकी शैक्षिक योग्यता" }
        },
        {
          id: "signatureName",
...
4. Letters of Recommendation`,
      fields: [
        ...
        },
        {
          ...
          label: { en: "Subject Line", hi: "विषय पंक्ति" },
          type: "text" as const,
          placeholder: { en: "Application for Senior Teacher Position", hi: "वरिष्ठ शिक्षक पद के लिए आवेदन" },
        ...
        },
        {
          ...
          defaultValue: "I am writing to express my strong interest in the teaching position at your prestigious institution. With over X years of teaching experience, I have developed a proven track record of helping students achieve academic excellence."
        },
        {
          id: "subject",
        ...
        },
        {
          ...
          defaultValue: "5",
          tooltip: { en: "Total years of teaching experience", hi: "शिक्षण अनुभव के कुल वर्ष" }
        },
        {
          id: "achievement",
          label: { en: "Key Achievement", hi: "प्रमुख उपलब्धि" },
          type: "text" as const,
          placeholder: { en: "Improved student performance by 25% in board exams", hi: "बोर्ड परीक्षाओं में छात्र प्रदर्शन में 25% सुधार" },
        ...
        },
        {
          ...
          type: "text" as const,
          placeholder: { en: "Served as Department Head for 2 years", hi: "2 वर्षों तक विभाग प्रमुख के रूप में सेवा की" },
