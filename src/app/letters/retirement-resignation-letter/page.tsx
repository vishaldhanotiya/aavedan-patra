...
export const metadata = generateMetadata({
  title:  "सेवानिवृत्ति इस्तीफा पत्र – Retirement Resignation Letter Hindi | AavedanPatra",
  description:
...
export default function Page() {
  return (
    <>
      <PillarTemplateDetailsPage singleTemplate data={retirementResignationTemplate} />
    </>
  );
}
