...
export const metadata = generateMetadata({
  title: "बोनाफाइड सर्टिफिकेट आवेदन – Bonafide Certificate Application Hindi | AavedanPatra",
  description:
  ...
  path: "/applications/certificates/bonafide-certificate-request-application",
});
