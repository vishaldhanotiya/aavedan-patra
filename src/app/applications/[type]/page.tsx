...
const metaMap: Record<string, { title: string; description: string }> = {
  ...
  loan: {
    title: "लोन आवेदन पत्र हिंदी में – Loan Application Format | AavedanPatra",
    description:
      "पर्सनल, होम, कार, एजुकेशन और बिज़नेस लोन के लिए हिंदी आवेदन पत्र। बैंक को सही तरीके से अप्लाई करें – तैयार नमूने और टिप्स।",
  },

  admission: {
    title:
      "स्कूल-कॉलेज प्रवेश आवेदन पत्र – Admission Application Hindi | AavedanPatra",
    description:
  ...
  scholarship: {
    title:
      "छात्रवृत्ति आवेदन पत्र हिंदी में – Scholarship Application | AavedanPatra",
    description:
