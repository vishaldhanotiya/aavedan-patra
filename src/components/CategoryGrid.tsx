...
import { FileText, Mail, Award, FileUser, FileBarChart, AtSign, ArrowRight } from "lucide-react";
    ...
    <section className="py-24 relative">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-slate-600 dark:text-white/60 text-lg">Browse through our curated collection of professional templates</p>
        </motion.div>
            ...
            >
              ...
              <div className="relative bg-white/80 dark:bg-white/5 backdrop-blur-xl border border-slate-200 dark:border-white/10 rounded-[24px] p-8 transition-all duration-300 group-hover:bg-white/90 dark:group-hover:bg-white/10 group-hover:border-slate-300 dark:group-hover:border-white/30 overflow-hidden group-hover:shadow-2xl">
                ...
                <div className="relative z-10">
                  {/* Icon */}
                  <div className={`w-16 h-16 mb-6 rounded-2xl bg-gradient-to-br ${category.gradient} flex items-center justify-center shadow-lg`}>
                    <category.icon className="w-8 h-8 text-white" />
                  </div>

                  {/* Content */}
                  <h3 className="text-2xl text-slate-900 dark:text-white mb-3">{category.title}</h3>
                  <p className="text-slate-600 dark:text-white/60 mb-6">{category.description}</p>
